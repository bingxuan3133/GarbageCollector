...
void test_phase1Mark_should_do_nothing_if_object1_is_marked(void) {
	ObjectA *ptr;
  ObjectA object = {.reference = 1, .flag = MARK, .free = freeObjectA, .ptrA = NULL};
...
void test_phase2Mark(void) {
	ObjectA *ptr;
  ObjectA object = {.reference = 0, .flag = 0, .free = freeObjectA, .ptrA = NULL};
...
void test_phase3Sweep_should_not_sweep_KEEPSTART_object_and_add_1_on_its_reference(void) {
	ObjectA *ptr;
  ObjectA object = {.reference = 0, .flag = KEEPSTART, .free = freeObjectA, .ptrA = NULL};
...
void test_phase3Sweep_should_not_sweep_KEEPFOLLOW_object_and_add_1_on_its_reference(void) {
	ObjectA *ptr;
  ObjectA object = {.reference = 0, .flag = KEEPFOLLOW, .free = freeObjectA, .ptrA = NULL};
